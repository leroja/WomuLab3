...
void Class1::Run(IBackgroundTaskInstance^ taskInstance)
{
	...
	taskInstance->Canceled += ref new BackgroundTaskCanceledEventHandler(this, &Class1::OnCanceled);
...
//
void Class1::OnCanceled(IBackgroundTaskInstance^ taskInstance, BackgroundTaskCancellationReason reason)
{
	//
