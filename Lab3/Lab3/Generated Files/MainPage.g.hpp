...
void ::Lab3::MainPage::InitializeComponent()
{
    if (_contentLoaded)
    {
        return;
...
void ::Lab3::MainPage::Connect(int __connectionId, ::Platform::Object^ __target)
{
        ...
        case 2:
            {
                ...
                (safe_cast<::Windows::UI::Xaml::Controls::Button^>(this->Continue))->Click += ref new ::Windows::UI::Xaml::RoutedEventHandler(this, (void (::Lab3::MainPage::*)
                    (::Platform::Object^, ::Windows::UI::Xaml::RoutedEventArgs^))&MainPage::Continue_Click);
            }
            break;
    }
    _contentLoaded = true;
...
::Windows::UI::Xaml::Markup::IComponentConnector^ ::Lab3::MainPage::GetBindingConnector(int __connectionId, ::Platform::Object^ __target)
{
